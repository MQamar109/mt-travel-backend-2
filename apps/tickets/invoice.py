...
def generate_ticket_invoice(ticket, display_currency, optional_fields, billing=None):
    """
    ...
    company_block = invoice_footer_flowables(billing or COMPANY, s_footer_b, s_footer, _DIVIDER)
