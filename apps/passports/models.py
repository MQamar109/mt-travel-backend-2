...
class Passport(TimeStampedModel):
    ...
    vendor = models.ForeignKey(Vendor, on_delete=models.PROTECT, related_name='passports')
    created_by = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.PROTECT, related_name='passports')
    ...
    class Meta:
        ...
        constraints = [
            models.UniqueConstraint(fields=['organization', 'invoice_no'], name='uniq_passport_invoice_per_org'),
        ]
